        ...
        Citizen.CreateThread(function()
            ...
            while true do
                ...
                RageUI.IsVisible(RMenu:Get("meteo","main"),true,true,true,function()
                    ...
                    RageUI.ButtonWithStyle("Heure", "Vous permets de cahnger le moment de la journée", { RightLabel = "→→" }, not cooldown, function()
                    end, RMenu:Get('heure', 'main'))
                    RageUI.ButtonWithStyle("Temps", "Vous permets de cahnger la météo", { RightLabel = "→→" }, not cooldown, function()
