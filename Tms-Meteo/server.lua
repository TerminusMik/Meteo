...
admins = {
    'steam:1100001363a7e46', -- Terminus
...
AddEventHandler("Soleil", function(message)
    TriggerClientEvent("esx:showAdvancedNotification", -1, "Annonce", "~r~Alerte Météo", message, "CHAR_LS_TOURIST_BOARD", 1)
end)

RegisterServerEvent("orage")
AddEventHandler("orage", function(message)
    TriggerClientEvent("esx:showAdvancedNotification", -1, "Annonce", "~r~Alerte Météo", message, "CHAR_LS_TOURIST_BOARD", 1)
end)

RegisterServerEvent("pluie")
AddEventHandler("pluie", function(message)
    TriggerClientEvent("esx:showAdvancedNotification", -1, "Annonce", "~r~Alerte Météo", message, "CHAR_LS_TOURIST_BOARD", 1)
end)

RegisterServerEvent("purge")
AddEventHandler("purge", function(message)
    TriggerClientEvent("esx:showAdvancedNotification", -1, "Annonce", "~r~Alerte Totale", message, "CHAR_LESTER_DEATHWISH", 1)
end)


RegisterServerEvent("blackout")
AddEventHandler("blackout", function(message)
    TriggerClientEvent("esx:showAdvancedNotification", -1, "Annonce", "~r~Centrale éléctrique", message, "CHAR_BLOCKED", 1)
end)
